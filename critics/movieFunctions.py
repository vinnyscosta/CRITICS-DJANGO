...
def discoverMovie():
    url_moviedb = f"{settings.URL_THE_MOVIE_DB}trending/movie/week?language=pt-BR&page=1&sort_by=popularity.desc"
...
def providersMovie(movieId):
    url_moviedb = f"https://api.themoviedb.org/3/movie/{movieId}/watch/providers?language=pt-BR"
